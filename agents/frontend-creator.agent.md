---
description: "Build React 19 + TypeScript frontend features: components, pages, hooks, services, routing. Use when: creating UI components, building feature pages, implementing forms, adding data fetching, building responsive layouts, or scaffolding new frontend features with TailwindCSS v4."
...
- DO NOT write backend code — delegate to the backend-creator agent
